...
Before asking a question, please check existing [issues](https://xk6-browser-safari/issues) and search online for solutions. If you still need help, clarification, or want to connect with the team and community, join our [community forums](https://community.grafana.com/c/grafana-k6).

## Reporting Bugs

Report bugs and errors using GitHub [issues](https://xk6-browser-safari/issues).
...
Feature requests are managed as GitHub [issues](https://xk6-browser-safari/issues).

Before submitting a new suggestion:

* Ensure you are using the latest version.  
* Carefully review the documentation to see if the functionality already exists.  
* Search existing [issues](https://xk6-browser-safari/issues) to avoid duplicates and add a comment if your idea is already present.  
...
1. Check existing [issues](https://xk6-browser-safari/issues) or create a new one to discuss your intended fix or feature.  
...
Use [mdcode] tool to update the browser_safari code blocks in `README.md`
